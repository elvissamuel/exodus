...
<div className="bg-white rounded-xl border-gray border mt-10   " ref={invoiceRef}>
                ...
                <p className="text-xs lg:text-sm mt-1 font-bold">Bill To:</p>
                    <p className="text-xs lg:text-sm mt-1">{props.temp_book.name}</p>
                    <p className="text-xs lg:text-sm mt-1">{props.temp_book.email}</p>
                    <p className="text-xs lg:text-sm mt-1">{props.temp_book.phone_number}</p>
...
<div className="border border-b-gray">
    <h1 className="text-right mt-4 text-xl font-bold">Total:   <span className="text-blue">{props.order.total}</span></h1>
</div>

<h1 className="text-center mt-10 mb-5 text-3xl font-bold">Quotation Details</h1>
<Book_Options_Table book={props.temp_book} />
                </div>
</div>
...
//    console.log(query.id)
    ...
    return { props: { order: data , temp_book} }
}
